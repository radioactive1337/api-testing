...
class SendrequestApi(Api):
    ...
    def create_user(self, req_body: UserModelRequest):
        with allure.step("creating a user"):
            return self.post(url=self._URL,
                             endpoint=self._ENDPOINT,
                             json_body=req_body.model_dump())

    def get_users_list(self, params: UserListModelRequest):
    ...
    def update_user(self, uid: int, req_body: UserModelRequest):
